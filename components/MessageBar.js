...
export default function MessageBar() {
    return (
        <div className="flex flex-row justify-between h-14 p-2 items-center bg-gray-200">
            <div className="flex flex-row flex-none ml-2 space-x-2 ">
            ...
            <div className="flex flex-row flex-grow">
                <div class="flex flex-row flex-grow items-center bg-white px-4 py-2 mx-3 text-gray-800 text-center rounded-full">
                    <div className="flex flex-grow ml-2 text-sm text-gray-500">
                        <input className="flex flex-auto outline-none" type="text" name="search" id="search" placeholder="Digite uma mensagem" />
                    </div>
                </div>
            </div>
            <div className="flex flex-row flex-none justify-between space-x-2">
                <button className="p-2 text-gray-500 focus:outline-none focus:bg-gray-300 focus:rounded-full">
